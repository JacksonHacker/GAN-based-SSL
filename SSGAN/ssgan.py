...
net = GAN(real_size, z_size, learning_rate, extra_class=extra_class, is_NCHW=is_NCHW)
...
# create a re-initializable iterator.
# It is shared by 'dataset_train' and 'dataset_test'
...
accuracies_filename = os.path.join(statistics_dir, 'accuracies.txt')
...
plt.title("Accuracy")
plt.legend()
plt.savefig(os.path.join(statistics_dir, 'accuracies'))
# plt.show()
print('plot end')